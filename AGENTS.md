...
- `.agents/skills/experience-to-intent/` 是“体验驱动意图收敛”技能的标准可安装来源；不要把它移动到展示页面目录或改成非标准目录名。
- 该技能的展示、来历和案例在 `体验驱动意图收敛-ExperienceToIntent/`。修改技能指令或参考资料时，同步检查展示页中的说明是否仍准确。
